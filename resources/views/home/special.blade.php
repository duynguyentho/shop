        ...
        <div class="col-lg-12 tm-popular-items-container">
          ...
          <div class="tm-popular-item">
            ...
            <div class="tm-popular-item-description">
              <h3 class="tm-handwriting-font tm-popular-item-title"><span class="tm-handwriting-font bigger-first-letter">{{$items->name[0]}}</span>{{substr($items->name, 1, strlen($items->name)-1)}}</h3><hr class="tm-popular-item-hr">
